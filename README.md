...
- WebGL 2 renderer with one continuous perspective plane, opposing tilt projection, depth-linked blur and brightness, cover cropping, and capped device-pixel ratio
